...
public interface BaseMapper<T1, T2, T3> {

	public int add(T1 entity);

	public int delete(T2 id);

	public int update(T1 entity);
	
	public abstract int updateByMap(Map<String, Object> params);
	...
	public List<T1> pageRequest(PageRequest<T3> request);
}
